...
var _template = node_path.resolve(cwd, (argv.template || './web/example/template.html')),
    _data = node_path.resolve(cwd, (argv.data || './web/example/' + node_env + '.json')),
...
module.exports = {
    context: node_path.join(cwd, './web/example'),
    mode: node_env,
    devtool: 'source-map',
    entry: {
        "index": "./src/index.js"
    ...
    output: {
        path: node_path.join(cwd, './web/example/www'),
    ...
    devServer: {
        compress: true,
        contentBase: node_path.resolve(cwd, "./web/example/www/"),
        ...
        new CopyWebpackPlugin([
            {
                ...
                to: node_path.resolve(cwd, './web/example/www/externals/'),
                force: true
            },
            {
